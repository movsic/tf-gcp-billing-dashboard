output "looker_report_link" {
  ...
  value       = "https://datastudio.google.com/reporting/create?c.reportId=${var.looker-template-report-id}&r.reportName=${var.looker-report-name}&ds.ds8.refreshFields=false&ds.ds8.connector=bigQuery&ds.ds8.projectId=${local.project-id}&ds.ds8.type=TABLE&ds.ds8.datasetId=${var.bq-dashboard-dataset-name}&ds.ds8.tableId=${var.bq-dashboard-view-name}"
}
